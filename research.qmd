...
**Yui Nishimura** and  [Atsushi Tago](https://a-tago.github.io/). "Are Shared Values Valuable? Liberal Democracy and Human Rights for AUKUS and Its Future Membership." 2023. *International Journal* 78(3) <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="collapse" data-bs-target="#abstract_ij" aria-expanded="false" aria-controls="abstract_ij"> Abstract </button> <button class="btn btn-primary btn-sm" onClick="window.open('https://journals.sagepub.com/doi/10.1177/00207020231201575');">Publisher</button> 

```{=html}
  <div class="collapse" id="abstract_ij">
    <div class="card card-body">
